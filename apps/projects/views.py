...
from .models import Project, TaskTemplate, TaskTemplateItem, ProjectTask, DailyProgressLog, ManpowerDeployment, ProjectMaterial, ProjectSignOff
from .forms import ProjectForm, TaskTemplateForm, TaskTemplateItemForm, ProjectTaskForm, DailyProgressLogForm, ManpowerDeploymentForm, ProjectMaterialForm
...
class ProjectDetailView(AdminRequiredMixin, DetailView):
    ...
    def get_queryset(self):
        return super().get_queryset().select_related('project_manager', 'site_engineer', 'branch', 'sign_off')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['progress_logs'] = self.object.progress_logs.select_related('logged_by', 'project').all().order_by('-date', '-created_at')
...
class ProjectExportPDFView(AdminRequiredMixin, View):
    def get(self, request, project_id):
        ...
        project = get_object_or_404(
            Project.objects.select_related('branch', 'sign_off')
            .prefetch_related(
        ...
        # 1. Main Title
        elements.append(Paragraph("HVAC PROJECT WORK PLAN SHEET", title_style))
        ...
        info_data = [
            ...
            [Paragraph("Location:", body_bold), Paragraph(project.location, body_style),
             Paragraph("System Type:", body_bold), Paragraph(project.system_type, body_style)],
