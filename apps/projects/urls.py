...
urlpatterns = [
    ...
    path('tasks/<int:pk>/delete-alias/', views.ProjectTaskDeleteView.as_view(), name='task_delete'),
    ...
    path('<int:project_id>/tasks/bulk-delete/', views.ProjectTaskBulkDeleteView.as_view(), name='project_task_bulk_delete'),
